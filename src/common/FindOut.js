                    ...
                    <Grid textAlign="center">
                        ...
                        <Grid.Row>
                            <Grid.Column textAlign="center" width={4}>
                                <Icon inverted color="green" size="huge" name="list" />
                                <Header style={{fontSize: '2.5em'}} content='Peace of mind' />
                                <Header 
                                    as='h2' 
                            ...
                            <Grid.Column textAlign="center" width={4}>
                                <Icon inverted color="green" size="huge" name="money" />
                                <Header style={{fontSize: '2.5em'}} content='Great Value' />
                                <Header 
                                    as='h2' 
                            ...
                            <Grid.Column textAlign="center" width={4}>
                            <Icon inverted color="green" size="huge" name="check circle" />
                                <Header style={{fontSize: '2.5em'}} content='Delivery Time Guaranteed' />
                                <Header 
                                    as='h2' 
