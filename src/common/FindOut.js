                    ...
                    <Grid textAlign="center">
                        ...
                        <Grid.Row>
                            <Grid.Column textAlign="center" width={4}>
                                <Icon inverted color="green" size="large" name="list" />
                                <Header style={{fontSize: '2em'}} content='Peace of mind' />
                                <Header 
                                    as='h3' 
                            ...
                            <Grid.Column textAlign="center" width={4}>
                                <Icon inverted color="green" size="large" name="money" />
                                <Header style={{fontSize: '2em'}} content='Great Value' />
                                <Header 
                                    as='h3' 
                            ...
                            <Grid.Column textAlign="center" width={4}>
                            <Icon inverted color="green" size="large" name="check circle" />
                                <Header style={{fontSize: '2em'}} content='Delivery Time Guaranteed' />
                                <Header 
                                    as='h3' 
